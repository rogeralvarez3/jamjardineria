...
export declare function getNestedValue(obj: any, path: readonly (string | number)[], fallback?: any): any;
...
export declare function isPercentage(value: unknown): value is string;
export declare function resolveSize(value: number | string | undefined, spanSize?: number): number;
