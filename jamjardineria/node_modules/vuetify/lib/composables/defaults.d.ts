...
export declare const RootDefaultsSymbol: InjectionKey<Ref<DefaultsInstance>>;
...
export declare function injectComponentDefaults<T = Record<string, unknown>>(name: string): Readonly<Ref<Partial<T> | undefined, Partial<T> | undefined>>;
export declare function injectNestedDefaults<T = Record<string, unknown>>(name: string): Readonly<Ref<Partial<T> | undefined, Partial<T> | undefined>>;
