...
export function maskSegmentsFrom(segments, text, startIndex = 0, caret = -1) {
...
export function toMaskSource(input, noise, caret = -1) {
...
export function maskInput(segments, input, noise, caret = -1, decorate) {
...
//# sourceMappingURL=segmentedMask.js.map