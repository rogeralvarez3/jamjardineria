...
import type { IgnoreAccents, MaybeRef } from '../util/index.js';
/**
...
export declare function createDefaultFilter(ignoreAccents?: IgnoreAccents): FilterFunction;
...
export declare const makeFilterProps: <Defaults extends {
    ...
    ignoreAccents: unknown extends Defaults["ignoreAccents"] ? PropType<IgnoreAccents> : {
        type: PropType<unknown extends Defaults["ignoreAccents"] ? IgnoreAccents : Defaults["ignoreAccents"] | IgnoreAccents>;
        default: unknown extends Defaults["ignoreAccents"] ? IgnoreAccents : Defaults["ignoreAccents"] | NonNullable<IgnoreAccents>;
    };
