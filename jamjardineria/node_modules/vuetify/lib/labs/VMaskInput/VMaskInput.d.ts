...
export declare const makeVMaskInputProps: <Defaults extends {
    ...
    detailsActive: unknown extends Defaults["detailsActive"] ? {
        ...
        type: import("vue").PropType<unknown extends Defaults["detailsActive"] ? boolean : boolean | Defaults["detailsActive"]>;
    ...
    counter: unknown extends Defaults["counter"] ? {
        ...
        type: import("vue").PropType<unknown extends Defaults["counter"] ? string | number | boolean | null : string | number | boolean | Defaults["counter"] | null>;
