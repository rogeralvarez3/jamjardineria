...
import { convertToUnit, genericComponent, isFunction, isObject, pick, propsFactory } from "../../util/index.js"; // Types
...
export const VPie = genericComponent()({
  ...
  setup(props, {
    ...
    const legendTextFormatFunction = toRef(() => item => {
      return isFunction(legendConfig.value.textFormat) ? legendConfig.value.textFormat(item) : formatTextTemplate(legendConfig.value.textFormat, item);
    });
    const arcs = computed(() => {
