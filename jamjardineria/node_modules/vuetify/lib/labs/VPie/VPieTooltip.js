...
import { genericComponent, isFunction, pick, propsFactory } from "../../util/index.js"; // Types
...
export const VPieTooltip = genericComponent()({
  ...
  setup(props, {
    ...
    const tooltipTitleFormatFunction = toRef(() => segment => {
      return isFunction(props.titleFormat) ? props.titleFormat(segment) : formatTextTemplate(props.titleFormat, segment);
    });
    const tooltipSubtitleFormatFunction = toRef(() => segment => {
      return isFunction(props.subtitleFormat) ? props.subtitleFormat(segment) : formatTextTemplate(props.subtitleFormat, segment);
    });
