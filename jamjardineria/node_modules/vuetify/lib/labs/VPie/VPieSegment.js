...
import { easingPatterns, genericComponent, isObject, propsFactory, useTransition } from "../../util/index.js"; // Types
...
export const VPieSegment = genericComponent()({
  ...
  setup(props) {
    ...
    const transitionConfig = computed(() => {
      ...
      const easingName = isObject(props.animation) ? props.animation.easing ?? defaultEasing : defaultEasing;
      return {
        duration: ['initial', 'pending'].includes(revealState.value) ? revealDuration.value : isObject(props.animation) ? props.animation.duration : props.animation ? defaultDuration : 0,
